 ...
 */
class SecurityMaxHelper extends Helper
{
   ...
   public static function encryptIt( $q ) {
	...
	/*
	* This Function Encrypt the md5 string to orignal string
	* @param you should pass orignal string to use this function
...
public static function decryptIt( $q ) {
	/*
	* This Function Decrypt the md5 string to orignal string
	* @param you should pass orignal string to use this function
	* @return MD5 Decrypted string 
	* @writer Manish Garg
...
public static  function checkAdminLogin($strSessionData)
{
    if($strSessionData>0)
    {
        return true;
