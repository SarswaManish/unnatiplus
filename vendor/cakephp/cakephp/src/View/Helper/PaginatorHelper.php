...
class PaginatorHelper extends Helper
{
    ...
    protected $_defaultConfig = [
        'options' => [],
        'templates' => [
            'nextActive' => '<a rel="next" class="paginate_button next" href="{{url}}">{{text}}</a>',
            'nextDisabled' => '<a href=""  class="paginate_button next disabled" onclick="return false;">{{text}}</a>',
            'prevActive' => '<a rel="prev"  class="paginate_button previous" href="{{url}}">{{text}}</a>',
            'prevDisabled' => '<a href="" class="paginate_button previous disabled" onclick="return false;">{{text}}</a>',
            'counterRange' => '{{start}} - {{end}} of {{count}}',
            'counterPages' => '{{page}} of {{pages}}',
            'first' => '<a class="paginate_button" href="{{url}}">{{text}}</a>',
            'last' => '<a class="paginate_button" href="{{url}}">{{text}}</a>',
            'number' => '<a class="paginate_button" href="{{url}}">{{text}}</a>',
            'current' => '<a class="paginate_button current" href="">{{text}}</a>',
            'ellipsis' => '<li class="ellipsis">&hellip;</li>',
            'sort' => '<a class="paginate_button" href="{{url}}">{{text}}</a>',
            'sortAsc' => '<a  class="asc paginate_button" href="{{url}}">{{text}}</a>',
            'sortDesc' => '<a  class="desc paginate_button" href="{{url}}">{{text}}</a>',
            'sortAscLocked' => '<a class="asc locked paginate_button"  href="{{url}}">{{text}}</a>',
            'sortDescLocked' => '<a class="desc locked paginate_button" href="{{url}}">{{text}}</a>',
        ]
    ];
