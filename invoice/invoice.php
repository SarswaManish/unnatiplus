...
<link rel="stylesheet" href="/admin/css/icons/icomoon/styles.css"/><link rel="stylesheet" href="/admin/css/bootstrap.css"/>
<link rel="stylesheet" href="/admin/css/core.css"/><link rel="stylesheet" href="/admin/css/components.css"/>
...
<script src="/admin/js/plugins/visualization/d3/d3.min.js"></script><script src="/admin/js/plugins/visualization/d3/d3_tooltip.js"></script><script src="/admin/js/plugins/forms/styling/switchery.min.js"></script><script src="/admin/js/plugins/forms/styling/switch.min.js"></script>
...
<?php 
     ...
     $resTransList =$conn->query('SELECT * FROM transactions INNER JOIN sk_product ON product_id=trans_item_id WHERE 1  AND (trans_main_id='.$rowTransactionInfo->trans_id.' OR trans_id='.$rowTransactionInfo->trans_id.')')->fetchAll();
...
?>
<tr>
<td style="text-align:center;vertical-align: top;"><?php echo $rowTransList->product_name; ?></td>
<td style="text-align:center;vertical-align: top;">Product Detail</td>
<td style="text-align:center;vertical-align: top;">-</td>
<td style="text-align:center;vertical-align: top;"><?php echo $rowTransList->trans_quantity; ?></td>
<td style="text-align:center;vertical-align: top;">RS.<?php  echo $rowTransList->trans_unit_price; ?></td>
<td style="text-align:center;vertical-align: top;">RS.<?php  echo $rowTransList->trans_unit_price*$rowTransList->trans_quantity; ?></td>
</tr>
<?php }  ?>
<tr>
...
<td style="text-align:center;">RS.<?php  echo $intTotalAMountIncludingDelivery-$rowTransactionInfo->trans_delivery_amount; ?></td>
</tr>
<tr>
...
<td style="text-align:center;"><?php if($rowTransactionInfo->trans_discount_amount>0) { echo 'RS.'.$rowTransactionInfo->trans_discount_amount; }else{ echo 'RS.0.00'; } ?></td>
</tr>
<tr>
<td style="text-align:center;">&nbsp;</td>
<td style="text-align:center;" colspan="4">Total Taxable Value After Discount</td>
<td style="text-align:center;">RS.<?php echo $intTotalAMountIncludingDelivery-$rowTransactionInfo->trans_delivery_amount-$rowTransactionInfo->trans_discount_amount; ?></td>
</tr>
<tr>
<td style="text-align:center;">&nbsp;</td>
...
<td style="text-align:center;" colspan="2"></td>
<td style="text-align:center;"><?php if($rowTransactionInfo->trans_delivery_amount>0) { echo 'RS.'.$rowTransactionInfo->trans_delivery_amount; }else{ echo 'RS.0'; } ?></td>
</tr>
<tr>
<td style="text-align:center;">&nbsp;</td>
<td style="text-align:center;">&nbsp;</td>
<td style="text-align:center;" colspan="3">Total</td>
<td style="text-align:center;">RS.<?php  echo $intTotalAmount = $intTotalAMountIncludingDelivery-$rowTransactionInfo->trans_discount_amount; ?></td>
</tr>
<tr>
<td style="text-align:center;">Amount Chargeable in Words / INR :</td>
<td style="text-align:center;" colspan="5"><?php echo ucfirst(convertNumberToWord($intTotalAmount)); ?> only</td>
