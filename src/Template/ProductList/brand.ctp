...
<div class="page-title mb-10 mt-10">
</div>
<div class="short-by-section">
    <?php $resCategoryProductList->count();?>
<ul><!--
<li><strong>Short By:</strong></li>
<li class="active"><a href="#">Popularity</a></li>
<li><a href="">Price - Low to High</a></li> -->
 <li class="pull-right text-gray"> (<?= $this->Paginator->counter(['format' => __('Showing {{current}} to {{end}} of {{count}} entries')]) ?>)</li>
...
<img class="zoom-product" src="<?php echo SITE_UPLOAD_URL.SITE_PRODUCT_IMAGE_PATH.$rowCategoryProductList->product_featured_image; ?>" alt=""  onload="pagespeed.CriticalImages.checkImageForCriticality(this);">

 </a>
</div>
<div class="so-quickview text-center">
<a class="quickview" href="<?php echo SITE_URL;?>product-detail/<?php echo $rowCategoryProductList->product_slug;?>" title="Quick view"><i class="icon-eye"></i>
</a>
</div>
</div>
<div class="bottom-block">
<div class="pi-title"><?php echo $rowCategoryProductList->product_name;?> </div>
<div class="pi-price">
...
<a href="href="<?php echo SITE_URL;?>product-detail/<?php echo $rowCategoryProductList->product_slug;?>"" class="addtocart">ADD TO CART</a>
</div>
</div>
</div>
</div>
        ...
        <div class="modal-body">
            <div class="pls-side-box-body">
                <div class="psb-list-2">
                    <ul>
                    <?php foreach($resBrandInfo as $rowBrandInfo){ ?>
                        <li onclick="openurl('<?php echo SITE_URL; ?>brand/<?php echo $rowBrandInfo['brand_slug']; ?>')" >
                        <label class="co-check"   onClick="parent.location='<?php echo SITE_URL; ?>brand/<?php echo $rowBrandInfo['brand_slug']; ?>'"> <?php echo $rowBrandInfo->brand_name;?>
                         
                        <input type="checkbox" <?php echo (isset($rowCategoryInfo->brand_id) && $rowCategoryInfo->brand_id==$rowBrandInfo['brand_id'])?'checked="checked"':''; ?>>
                        <span class="checkmark"  onClick="parent.location='<?php echo SITE_URL; ?>brand/<?php echo $rowBrandInfo['brand_slug']; ?>'"></span>
                        </label>
                    </li>
                    <?php } ?>
                    </ul>
