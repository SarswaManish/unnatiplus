            ...
            <div class="short-by-section">
                <form id="filter" action="" method="post">
                    <ul><!--
                        ...
                        <li class="active"><a href="JavaScript:Void(0);" id="filter">Popularity</a></li>
                        <li><a href="JavaScript:Void(0);" id="filter" >Price - Low to High</a></li>-->
                ...
                <div class="col-lg-3 pr-5 pl-5">
                    <div class="product-item mb-10">
                        ...
                        <div class="bottom-block">
                            ...
                            <div class="bottom-block-footer"><?php echo $rowCategoryProductList->product_tagline;?></div>
...
$('#filter').on('click',function(){
    var filterId = $("#pop").val();
    var siteUrl = '<?php echo SITE_URL; ?>';
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url : siteUrl+'ProductList/sale',
        data: { data1: filterId},
