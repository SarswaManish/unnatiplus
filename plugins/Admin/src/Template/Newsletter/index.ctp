...
<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Newsletter</span> - Manage Newsletter</h4>
</div>
</div>
...
<h5 class="panel-title">Newsletter Listing</h5>
...
<div class="row">
 <?php echo  $this->Form->create('', ['url'=>'/admin/newsletter/bulkaction','type' => 'POST','id'=>'bulkaction','class'=>'form-horizontal']); ?>
<div class="col-md-4">
...
<input type="checkbox" name="newsletter_id[]" class="checkbox clsSelectSingle" value="<?= $this->Number->format($rowCouponInfo->newsletter_id);  ?>">
</td>
<td><?= h((($rowCouponInfo->newsletter_email!='')?$rowCouponInfo->newsletter_email:'-')); ?></td>

<td style="text-align:center"><?= date("d M, Y", strtotime($rowCouponInfo->newsletter_datetime)) ?></td>
