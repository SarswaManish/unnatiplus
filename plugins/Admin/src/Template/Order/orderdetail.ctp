                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="background:#fff">
                                                    <?php if($rowTransactionInfo->trans_status==1){ 
                                                        echo '<span class="label bg-success-400">Confirmed</span>';
                                                    }else if($rowTransactionInfo->trans_status==2){  
                                                        echo '<span class="label bg-primary">Cancel</span>';
                                                    }else if($rowTransactionInfo->trans_status==3){
                                                        echo '<span class="label bg-warning">Dispatched</span>';
                                                    }else if($rowTransactionInfo->trans_status==4){
                                                        echo '<span class="label bg-warning">Delivered</span>';
                                                    }else if($rowTransactionInfo->trans_status==5){
                                                        echo '<span class="label bg-warning">Return requested</span>';
                                                    }else if($rowTransactionInfo->trans_status==6){
                                                        echo '<span class="label bg-warning">Return</span>';
                                                    }else if($rowTransactionInfo->trans_status==7){
                                                        echo '<span class="label bg-warning">Intransit</span>';
                                                    }else{ 
                                                        echo '<span class="label bg-danger">Not Confirmed</span>';
                                                    } ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="background:#fff">
                                                    <?php if($rowTransactionInfo->trans_payment_status==1)
                                                    { ?>
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td style="background: #f3f3f3;">GST Number </td>
                                                <td style="background:#fff"><?php echo $rowTransactionInfo->trans_gst_number; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="background:#fff">
                                                    <p><?php echo $rowTransactionInfo['trans_delivery_address']; ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped">
                                        <tbody>
                                            <tr>
                                                <td style="background: #f3f3f3;">Deliver to </td>
                                                <td style="background:#fff">
                                                    <p><?php echo $rowTransactionInfo['trans_billing_address']; ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="panel-body">
                    <table class="table table-framed">
                        ...
                        <tbody>
                            ...
                            $resTransList =$conn->execute('SELECT * FROM transactions INNER JOIN sk_product ON product_id=trans_item_id LEFT JOIN sk_size ON size_id=trans_size WHERE 1  AND (trans_main_id='.$rowTransactionInfo->trans_id.' OR trans_id='.$rowTransactionInfo->trans_id.')')->fetchAll('assoc');
                            $intTotalAMountIncludingDelivery = 0;
                            $intGrandTotal =0;
                            foreach($resTransList as $rowTransList)
                            {
                                $rowTransList =(object)$rowTransList;
                                $intTotalAMountIncludingDelivery +=$rowTransList->trans_total_amt; 
                                $intGrandTotal += $rowTransList->trans_amt;
                                $rowSizeInfo = $resSizeObject->find('all',['keyField'=>'size_id','valueField'=>'size_id'])->where(['size_id '=>$rowTransList->trans_size])->toArray();
                            ?>
                            <tr>
                                ...
                                <td><?php echo $rowTransList->size_name; ?></td>
                                <td><span class="text-success-600">₹<?php  echo $rowTransList->trans_unit_price*$rowTransList->trans_quantity; ?></span></td>
                            </tr>
                            <?php }  ?>
                            <tr>
                                <td style="text-align:center" colspan="2">&nbsp;</td>
                                <td colspan="3" style="background: #f3f3f3;"><strong>Totals</strong></td>	
                            </tr>
                            <tr>
                                <td style="text-align:center;border: 0px;" colspan="2">&nbsp;</td>
                                <td style="background: #f3f3f3;">Item subtotal</td>	
                                <td colspan="3">₹<?php  echo $intTotalAMountIncludingDelivery; ?></td>	
                            </tr>
                            <tr>
                                <td style="text-align:center;border: 0px;" colspan="2">&nbsp;</td>
                                <td style="background: #f3f3f3;">Delivery Charge</td>	
                                <td colspan="3"><?php if($rowTransactionInfo->trans_delivery_amount>0) { echo '₹'.$rowTransactionInfo->trans_delivery_amount; }else{ echo 'Free'; } ?></td>	
                            </tr>
                            <tr>
                                <td style="text-align:center;border: 0px;" colspan="2">&nbsp;</td>
                                <td style="background: #f3f3f3;">Discount</td>	
                                <td colspan="3"><?php if($rowTransactionInfo->trans_discount_amount>0) { echo '₹'.$rowTransactionInfo->trans_discount_amount; }else{ echo '₹0.00'; } ?></td>	
                            </tr>
                            <tr>
                                <td style="text-align:center;border: 0px;" colspan="2">&nbsp;</td>
                                <td style="background: #f3f3f3;">GST</td>	
                                <td colspan="3"><?php if($rowTransactionInfo->trans_igst>0) { echo '₹'.$rowTransactionInfo->trans_igst; }else{ echo '₹0.00'; } ?></td>	
                            </tr>
                            <tr>
                                <td style="text-align:center;border: 0px;" colspan="2">&nbsp;</td>
                                <td style="background: #f3f3f3;"><strong>Grand total</strong></td>	
                                <td colspan="3"><strong>₹<?php  echo $intGrandTotal; ?></strong></td>	
                            </tr>
                        </tbody>
                    </table>
                </div>
