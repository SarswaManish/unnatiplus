                    ...
                    <div class="panel panel-flat" style="margin-bottom:0px; border-radius:0px; border-bottom: 0px;">
                        ...
                        <div class="panel-body" style="padding:20px 15px;">
                            <div class="form-group" id="category-name-error" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <div class="input text required">
                                        <input name="category_name" onkeyup="getCategoryslug(this.value)" placeholder="Enter Category Name" required="required" class="form-control" id="category_name" value="<?php echo isset($rowCategoryInfo->category_name)?$rowCategoryInfo->category_name:''; ?>" type="text">
                                    </div>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <div class="input text required">
                                        <input name="category_slug" placeholder="Enter Slug" class="form-control" id="category_slug" value="<?php echo isset($rowCategoryInfo->category_slug)?$rowCategoryInfo->category_slug:''; ?>" type="text">
                                    </div>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <div class="input text required">
                                        <input name="category_order" placeholder="Enter Order" class="form-control" id="category_order" value="<?php echo isset($rowCategoryInfo->category_order)?$rowCategoryInfo->category_order:''; ?>" type="number">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom:10px;">
                                ...
                                <div>
                                    <select class="bootstrap-select" placeholder="Select Parent" name="category_parent" data-live-search="true">
                                        ...
                                        ?>
                                        <option <?php echo $strSelect;?> value="<?php echo $rowCategoryDatalevel->category_id; ?>" class="blueText secondchild" data-icon="icon-dash icon-dash"><?php echo $rowCategoryDatalevel->category_name; ?>
                                        </option>
                                        <?php } ?>
                                        <?php }} ?>
                                    </select>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <textarea rows="3" cols="5" class="form-control" placeholder="Description" name="category_descri">
                                        <?php echo isset($rowCategoryInfo->category_descri)?$rowCategoryInfo->category_descri:''; ?>
                                    </textarea>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <input type="checkbox" <?php if(isset($rowCategoryInfo->category_show_menu) && $rowCategoryInfo->category_show_menu==1) { echo 'checked="checked"'; } ?> name="category_show_menu" value="1"> Yes
                                    <br>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <input type="checkbox" <?php if(isset($rowCategoryInfo->category_megamenu) && $rowCategoryInfo->category_megamenu==1) { echo 'checked="checked"'; } ?> name="category_megamenu" value="1"> Yes
                                    <br>
                                ...
                                <div>
                                    <div class="media no-margin-top">
                                        ...
                                        <div class="media-body">
                                            <div class="uploader">
                                                <input class="file-styled" onchange="readURL1(this)" type="file" name="category_icon_"><span class="filename" style="-moz-user-select: none;">No file selected</span><span class="action btn bg-pink-400" style="-moz-user-select: none;">Choose File</span></div>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <div class="media no-margin-top">
                                        ...
                                        <div class="media-body">
                                            <div class="uploader">
                                                <input class="file-styled" onchange="readURL(this)" type="file" name="category_banner_"><span class="filename" style="-moz-user-select: none;">No file selected</span><span class="action btn bg-pink-400" style="-moz-user-select: none;">Choose File</span></div>
                                            <span class="help-block">Accepted: gif, png, jpg. Max file size 2Mb</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div>
                                    <div class="media no-margin-top">
                                        <div class="media-left" style="padding-right: 5px;">
                                            <?php if(isset($rowCategoryInfo->category_app_icon) && ''!=$rowCategoryInfo->category_app_icon)
                                            { ?>
                                                <a href="#"><?php echo $this->Html->image(SITE_UPLOAD_URL.SITE_CATEGORY_ICON_PATH.$rowCategoryInfo->category_app_icon,array('id'=>"blash2",'style'=>'width: 58px; height: 58px; border-radius: 2px;'));?></a>
                                            <?php } else { ?>
                                                <a href="#"><?php echo $this->Html->image('Admin./images/placeholder.jpg',array('style'=>'width: 58px; height: 58px;','id'=>'blash2')); ?></a>
                                            <?php } ?>
                                        </div>
                                        <div class="media-body">
                                            <div class="uploader">
                                                <input class="file-styled" onchange="readURL2(this)" type="file" name="category_app_icon_"><span class="filename" style="-moz-user-select: none;">No file selected</span><span class="action btn bg-pink-400" style="-moz-user-select: none;">Choose File</span></div>
                                            <span class="help-block">Accepted: gif, png, jpg. Max file size 2Mb</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="accordion-control-right-group2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        ...
                                        <div>
                                            <div class="input text required">
                                                <input name="category_meta_title" placeholder="Enter meta title" class="form-control" value="<?php echo isset($rowCategoryInfo->category_meta_title)?$rowCategoryInfo->category_meta_title:''; ?>" type="text">
                                            </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        ...
                                        <div>
                                            <div class="input text required">
                                                <textarea rows="3" cols="5" class="form-control" name="category_meta_keyword" placeholder="Keyword-1, Keyword-2, Keyword-3... ">
                                                    <?php echo isset($rowCategoryInfo->category_meta_keyword)?$rowCategoryInfo->category_meta_keyword:''; ?>
                                                </textarea>
                                            </div>
                                    ...
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        ...
                                        <div>
                                            <div class="input text required">
                                                <textarea name="category_meta_desc" rows="3" cols="5" class="form-control" placeholder="Meta Description">
                                                    <?php echo isset($rowCategoryInfo->category_meta_desc)?$rowCategoryInfo->category_meta_desc:''; ?>
                                                </textarea>
                                            </div>
...
<script>
    var csrf_tocken = <?= json_encode($this->request->getParam('_csrfToken')); ?>;
</script>
<script>
    ...
    function readURL1(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            if (Extension == "gif" || Extension == "png" || Extension == "jpeg" || Extension == "jpg") {
                var reader = new FileReader();
                reader.onload = function(e) {
                    $('#blash2').attr('src', e.target.result);
                };
                reader.readAsDataURL(input.files[0]);
            } else {
                alert('Photo only allows file types of  PNG, JPG, JPEG');
