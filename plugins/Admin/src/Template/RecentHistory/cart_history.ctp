<div class="page-header page-header-default">
   <div class="page-header-content">
      <div class="page-title">
         <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Cart History</h4>
      </div>
   </div>
   <div class="breadcrumb-line">
      <ul class="breadcrumb">
         <li><a href="<?php echo SITE_URL; ?>admin/dashboard"><i class="icon-home2 position-left"></i> Home</a></li>
         <li class="active">Cart History</li>
      </ul>
   </div>
</div>
<div class="content">
   ...
   <div class="panel panel-default">
      ...
      <div class="panel-body" style="background:#f5f5f5;">
         <div class="row">
            <?php echo  $this->Form->create('', ['url'=>'/admin/recentHistory/cartbulkaction','type' => 'POST','id'=>'bulkaction','class'=>'form-horizontal']); ?>
            <div class="col-md-4">
         ...
         <tbody>
            ...
            <tr>
               <td style="text-align:left">
                  <input type="checkbox" name="cart_id[]" class="checkbox clsSelectSingle" value="<?= $this->Number->format($rowCartlistInfo->cart_id);  ?>">
               </td>
               <td> <?php echo ++$count; ?></td>
               <td><?php echo $rowCartlistInfo->sk_user->user_first_name?> <?php echo $rowCartlistInfo->sk_user->user_last_name?></td>
               <td>
                  <div class=""><a  target="new" href="<?php echo SITE_URL; ?>product-detail/<?php echo $rowCartlistInfo->sk_product->product_slug; ?>" class="text-default text-semibold"><?php echo $rowCartlistInfo->sk_product->product_name?></a></div>
               </td>
                  ...
                  <ul class="icons-list">
                     <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                           <li><a href="<?php echo SITE_URL; ?>admin/recentHistory/deletecart/<?php echo $rowCartlistInfo->cart_id; ?>" style="padding:3px 15px" onclick="return confirm('Are you sure you want to delete?');">Delete</a></li>
                        </ul>
                     </li>
                  </ul>
               </td>
