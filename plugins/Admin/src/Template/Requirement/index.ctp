...
<h5 class="panel-title">Requirement Listing</h5>
<div class="heading-elements">
    <a href="<?php echo SITE_URL;?>admin/requirement/export" class="btn btn-primary" style="margin-right:10px;"><i class="icon-database-export position-left"></i> Export</a>

</div>
</div>
<div class="panel-body" style="background:#f5f5f5;">
<div class="row">
 <?php echo  $this->Form->create('', ['url'=>'/admin/requirement/bulkaction','type' => 'POST','id'=>'bulkaction','class'=>'form-horizontal']); ?>
<div class="col-md-4">
...
<input type="checkbox" name="req_id[]" class="checkbox clsSelectSingle" value="<?= $this->Number->format($rowCouponInfo->req_id);  ?>">
</td>
<td> <?php echo ++$count; ?></td>
<td><?= h($rowCouponInfo->req_name); ?></td>
<td><?= h($rowCouponInfo->req_email); ?></td>
<td><?= h($rowCouponInfo->req_mobile); ?></td>
 
<td style="text-align:center"><?= date("d M, Y", strtotime($rowCouponInfo->req_created_date)) ?></td>
...
<li><a href="<?php echo SITE_URL; ?>admin/requirement/user-view/<?php echo $rowCouponInfo->req_id; ?>" style="padding:3px 15px">View</a></li>
							    <?php if($rowSelectPermission['pd_delete']==1)
{ ?>														
											<li><a href="<?php echo SITE_URL; ?>admin/requirement/delete/<?php echo $rowCouponInfo->req_id; ?>" style="padding:3px 15px" onclick="return confirm('Are you sure you want to delete?');">Delete</a></li>		<?php } ?>				
