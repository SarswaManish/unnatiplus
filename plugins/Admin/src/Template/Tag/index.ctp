			...
			<div class="panel panel-flat" style="margin-bottom:0px; border-radius:0px; border-bottom: 0px;">
				<div class="panel-body" style="padding:20px 15px;">
					...
					<div class="form-group" style="margin-bottom: 10px;">
    					...
    					<div>
        					<input type="checkbox"  <?php if(isset($rowTagInfo->tag_show_menu) && $rowTagInfo->tag_show_menu==1) { echo 'checked="checked"';  } ?> name="tag_show_menu" value="1"> Yes<br>
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
					        ...
					        <td style="text-align:center"> 
                                <?php	if($rowTagListInfo->tag_status==1)
                                { ?>
                                <a href="<?php echo SITE_URL; ?>admin/tag/status/<?php echo $rowTagListInfo->tag_id; ?>"><span class="label label-success">Active </span> </a>
                                <?php }else   { ?>
                                <a href="<?php echo SITE_URL; ?>admin/tag/status/<?php echo $rowTagListInfo->tag_id; ?>"> <span class="label label-danger ">Inactive</span>  </a>
                                <?php } ?>
                            </td>
