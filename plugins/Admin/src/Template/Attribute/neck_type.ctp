...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Neck Type</h4>
		</div>
	</div>
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
			<li><a href="<?php echo SITE_URL; ?>admin"><i class="icon-home2 position-left"></i> Home</a></li>
			<li class="active">Neck Type</li>
		</ul>
	</div>
</div>
    <!-- /page header -->
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo  $this->Form->create('', ['type' => 'POST','id'=>'tag-form','url'=>'/admin/attribute/neckTypeProcessRequest']); ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="background:#f5f5f5;">
                        <div class="row">
                            <?php echo  $this->Form->create('', ['url'=>'/admin/attribute/neckTypebulkaction','type' => 'POST','id'=>'bulkaction','class'=>'form-horizontal']); ?>
                            <div class="col-md-4">
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            { ?>
                                                <li><a href="<?php echo $this->Url->build('/admin/attribute/neckType/'.$rowFabricListInfo->attterms_id); ?>" style="padding:3px 15px">Edit</a></li>
                                            <?php } ?>
                                            <?php if($rowSelectPermission['pd_delete']==1)
                                            { ?>
                                                <li><a href="<?php echo $this->Url->build('/admin/attribute/deleteneckType/'.$rowFabricListInfo->attterms_id); ?>" style="padding:3px 15px">Delete</a></li>
                                            <?php } ?>
                                            </ul>
                                        </li>
                                    </ul>
