...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Occasion</h4>
		</div>
	</div>
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-lg-4">
                <?php echo  $this->Form->create('', ['type' => 'POST','id'=>'tag-form','url'=>'/admin/attribute/occasionProcessRequest']); ?>
            ...
            <div class="col-lg-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="background:#f5f5f5;">
                        <div class="row">
                            <?php echo  $this->Form->create('', ['url'=>'/admin/attribute/occasionbulkaction','type' => 'POST','id'=>'bulkaction','class'=>'form-horizontal']); ?>
                            <div class="col-md-4">
                                ...
                                <td class="text-center">
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            { ?>
                                                <li><a href="<?php echo $this->Url->build('/admin/attribute/occasion/'.$rowFabricListInfo->attterms_id); ?>" style="padding:3px 15px">Edit</a></li>
                                            <?php } ?>
                                            <?php if($rowSelectPermission['pd_delete']==1)
                                            { ?>
                                                <li><a href="<?php echo $this->Url->build('/admin/attribute/deleteoccasion/'.$rowFabricListInfo->attterms_id); ?>" style="padding:3px 15px">Delete</a></li>
                                            <?php } ?>
                                            </ul>
                                        </li>
                                    </ul>
