<?php  namespace Admin\Controller\Component;
...
class MpdfComponent extends Component {
    ...
    public function init($configuration = array()) {
     ...
     //  App::import('Vendor', 'Mpdf.mpdf/mpdf');
      ...
      require_once(ROOT . 'vendor' . DS  . 'Mpdf' . DS . 'Mpdf' . DS . 'mpdf.php');
     ...
     */
    public function shutdown(Event $controller) {
        if ($this->_init) {
            $strHtml ='dsadadas';
            $this->pdf->WriteHTML((string)$strHtml);
