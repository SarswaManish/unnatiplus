...
<?php $rowSellerInfo = $this->request->getSession()->read('SELLER')?>
...
<!-- Content area -->
<div class="content">
    <?php echo  $this->Form->create('', ['type' => 'POST','id'=>'category-form','url'=>'/seller/product/ProductProcessRequest','enctype'=>'multipart/form-data']); ?>
	...
	<input type="hidden" name="product_seller_id" value="<?php echo $rowSellerInfo['seller_id']; ?>">
	<!-- Dashboard content -->
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-default">
				...
				<div class="panel-body" style="padding:20px 15px;">
					<div class="form-group" style="margin-bottom: 10px;">
    					...
    					<div>
        					<div class="input text required"><input name="product_name" onkeyup="return getproductslug(this.value)" placeholder="Enter Product Name / Title"  class="form-control" id="product_name" value="<?php echo isset($rowProductInfo['product_name'])?$rowProductInfo['product_name']:''; ?>" type="text"></div>   
					...
					<div class="form-group" style="margin-bottom: 10px;">
    					...
    					<div>
    					    <div class="input text required"><input name="product_sku" placeholder="Enter Product Code / SKU"  class="form-control" id="product_sku" value="<?php echo isset($rowProductInfo['product_sku'])?$rowProductInfo['product_sku']:''; ?>" type="text"></div>   
    					</div>
					</div>
                    <div class="form-group" style="margin-bottom: 10px;">
    					<label class="control-label">Product Code / HSN: <span style="color:red">*</span></label>
    					<div>
    					    <div class="input text required"><input name="product_hsn" placeholder="Enter Product Code / HSN"  class="form-control" id="product_hsn" value="<?php echo isset($rowProductInfo['product_hsn'])?$rowProductInfo['product_hsn']:''; ?>" type="text"></div>   
    					</div>
					</div>
					<div class="form-group" style="margin-bottom: 10px;">
    					<label class="control-label">Product Delivery Days: <span style="color:red">*</span></label>
    					<div>
    					    <div class="input text required"><input name="product_delivery_text"  placeholder="Enter Delivery Estimation Time Eg 4-7 days"  class="form-control" id="product_delivery_text" value="<?php echo isset($rowProductInfo['product_delivery_text'])?$rowProductInfo['product_delivery_text']:''; ?>" type="text"></div>   
    					</div>
					</div>
 				    <div class="form-group" style="margin-bottom: 10px;">
    					<label class="control-label">Min: <span style="color:red">*</span></label>
    					<select class="select" name="product_min">
    					    <option value="0">Select</option>
                                <?php for($i=0;$i<=10;$i++){?>
                                    <option <?php if(isset($rowProductInfo->product_min)&&$rowProductInfo->product_min==$i)echo "selected='selected'";?> value="<?php echo $i;?>"><?php echo $i;?></option>
                                <?php }?>
    					</select>
					</div>
				    <div class="form-group" style="margin-bottom: 10px;">
					    <label class="control-label">Max: <span style="color:red">*</span></label>
						<select class="select" name="product_max">
						    <option value="0">Select</option>
						    <?php for($i=0;$i<=10;$i++){?>
                                <option <?php if(isset($rowProductInfo->product_max)&&$rowProductInfo->product_max==$i)echo "selected='selected'";?> value="<?php echo $i;?>"><?php echo $i;?></option>
                            <?php }?>
					    </select>
					</div>
                </div>
		    ...
		    <div class="panel-group panel-group-control panel-group-control-right content-group-lg" id="accordion-control-right11" style="margin-bottom:20px !important;">
    			<div class="panel panel-white">
    				<div class="panel-heading">
    					<h6 class="panel-title">
    						<a data-toggle="collapse" data-parent="#accordion-control-right11" href="#accordion-control-right-group11">Specifications</a>
    					</h6>
    				</div>
    				<div id="accordion-control-right-group11" class="panel-collapse collapse in">
    					<div class="panel-body" style="padding:0px" >
    					    <textarea name="product_spec" class="summernote"><?php echo isset($rowProductInfo['product_spec'])?$rowProductInfo['product_spec']:''; ?></textarea>
    					</div>
    				</div>
    			</div>
			</div>
					...
					<div class="row clsparentforremove">
				        <div class="col-lg-3">
				            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div class="input text required">
                                    <select name="pu_unit[]" class="select">
				        ...
				        <div class="col-lg-3">
				            <div class="form-group" style="margin-bottom: 10px;">
                                ...
                                <div class="input text required">
                                    <select name="pu_size[]" class="select">
                                        <option>Select</option>
                                        <?php 
                                        $strSizeHtml ='';
				        ...
				        <div class="col-lg-2">
				            <div class="form-group" style="margin-bottom: 10px;">
				                ...
				                <div class="input text required">
				                    <input class="form-control" placeholder="0.00" type="text"  id="qty_price" name="pu_qty[]" value="<?php echo isset($rowProductBusinessArray->pu_qty)?$rowProductBusinessArray->pu_qty:''; ?>"> 
			                    </div>
		                    </div>
	                    </div>
                        <div class="col-lg-2">
                            <div class="form-group" style="margin-bottom: 10px; margin-right: -31px;">
                                ...
                                <div>
                                    <div class="input-group">
                                        ...
                                        <input class="form-control"  id="sellingprice" placeholder="0.00" type="text" name="pu_selling_price[]" value="<?php echo isset($rowProductBusinessArray->pu_selling_price)?$rowProductBusinessArray->pu_selling_price:''; ?>" onkeyup="getnetbusinessprice($(this))" onblur="getnetbusinessprice($(this))">
                                    </div>  
				        ...
				        <div class="col-lg-2">
				            <div class="form-group" style="margin-bottom: 10px;">
				                ...
				                <div class="input text required">
				                    <input class="form-control" placeholder="0.00" type="text"  id="qty_moq" name="pu_moq[]" value="<?php echo isset($rowProductBusinessArray->pu_moq)?$rowProductBusinessArray->pu_moq:''; ?>"> 
			                    </div>
		                    </div>
	                    </div>
	                    <div class="col-lg-2">
				            <div class="form-group" style="margin-bottom: 10px;">
				                ...
				                <div class="input text required">
				                    <input class="form-control" placeholder="0.00" type="text"  id="qty_item_pack" name="pu_item_pack[]" value="<?php echo isset($rowProductBusinessArray->pu_item_pack)?$rowProductBusinessArray->pu_item_pack:''; ?>"> 
			                    </div>
		                    </div>
	                    </div>
                        <div class="col-lg-1">
					...
					<div class="row clsparentforremove">
    			        ...
    			        <div class="col-lg-2">
    			            <div class="form-group" style="margin-bottom: 10px;">
        			            <label class="control-label">Avail Qty: <span style="color:red">*</span></label>
        			            <div class="input text required">
        			                <input class="form-control" placeholder="0.00" type="text"  id="qty_price" name="pu_qty[]" value=""> 
        		                </div>
        	                </div>
    	                </div>
    					<div class="col-lg-2">
        					<div class="form-group" style="margin-bottom: 10px; margin-right: -31px;">
            					...
            					<div>
                					<div class="input-group">
                    					<span class="input-group-addon">₹</span>
                    					<input class="form-control"  id="sellingprice" placeholder="0.00" type="text" name="pu_selling_price[]" value="" onkeyup="getnetbusinessprice($(this))" onblur="getnetbusinessprice($(this))">
                					</div>  
                					<span style="font-size:12px;color:#999; margin-top:10px;display: inline-block;"></span>
            					</div>
        					</div>
			            ...
			            <div class="col-lg-2">
    			            <div class="form-group" style="margin-bottom: 10px;">
        			            <label class="control-label">MOQ: <span style="color:red">*</span></label>
        			            <div class="input text required">
        			                <input class="form-control" placeholder="0.00" type="text"  id="qty_price" name="pu_moq[]" value=""> 
        		                </div>
        	                </div>
    	                </div>
	                    <div class="col-lg-2">
    			            <div class="form-group" style="margin-bottom: 10px;">
        			            <label class="control-label">Item in Pack: <span style="color:red">*</span></label>
        			            <div class="input text required">
        			                <input class="form-control" placeholder="0.00" type="text"  id="qty_price" name="pu_item_pack[]" value=""> 
        		                </div>
        	                </div>
    	                </div>
                        <div class="col-lg-1">
					...
					<div id="accordion-control-right-group11" class="panel-collapse collapse in">
						<div class="panel-body"  >
						    ...
						    <div class="row clsparentrow">
        						...
        						<div class="col-lg-2 clsaddmorebutton">
        						    <button type="button" onclick="addMoreHighlights($(this))" class="btn btn-info btn-xs"><i class="icon-plus2"></i> Add More</button>
        						</div>
							</div>
            ...
            <div class="panel panel-default">
				...
				<div class="panel-body" style="padding:20px 15px;">
				    <div class="row hide" style=" margin-bottom: 10px;" id="image-error">
					    <div class="col-lg-12">
					        <div class="alert alert-danger"> jpeg,jpg or png extension are allowed. </div>
					    </div>
					</div>
					<div class="row">
					    <div class="col-lg-6">
 								...
 								<div class="tab-content" style="border:1px solid #ddd;padding:0px 0px 0px 15px; margin-bottom:15px;">
								    <div class="tab-pane active" id="basic-tab1" style="height:200px; overflow-x:hidden;">
 								    ...
 								    <div class="tab-pane" id="basic-tab2" style="height:200px; overflow-x:hidden;">
									    <div class="form-group" style="padding:10px 0px;"> </div>
								    </div>
                                </div>
							</div>
										...
										<div class="media no-margin-top">
									        <div class="media-left" style="padding-right: 5px;">
                                    			...
                                    			{?>
                                     			...
                                     			<?php }else{ ?>
                                    			<a href="#"><img src="<?php echo SITE_URL;?>/admin/images/placeholder.jpg" style="width: 58px; height: 58px;" id="blash" alt=""></a>
                                     			<?php } ?>
										    </div>
                							<div class="media-body">
