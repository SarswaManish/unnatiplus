...
?>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Home</span> - Configure Term Of <strong><?php echo $rowTagInfo->att_name; ?> Attribute</strong></h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class=""><a href="<?php echo SITE_URL; ?>admin/attribute">Attribute</a></li>
							<li class="active">Configure Term Of <strong><?php echo $rowTagInfo->att_name; ?> Attribute</strong></li>
						</ul>
				...
				<div class="content">
					...
					<div class="row">
					<div class="col-lg-4">
						<?php echo  $this->Form->create('', ['type' => 'POST','id'=>'tag-form','url'=>'/admin/attribute/termsProcessRequest']); ?>
				    <input type="hidden" name="attterms_att_id" value="<?php echo  isset($rowTagInfo->att_id)?$rowTagInfo->att_id:'0'; ?>">
					    <input type="hidden" name="attterms_id" value="<?php echo  isset($rowTermsInfo->attterms_id)?$rowTermsInfo->attterms_id:'0'; ?>">
				<div class="panel panel-flat" style="margin-bottom:0px; border-radius:0px; border-bottom: 0px;">
					...
					<div>
					<div class="input text required"><input name="attterms_name" onkeyup="getTagslug(this.value)" placeholder="Enter Attribute Name"  class="form-control" id="tag_name" value="<?php echo  isset($rowTermsInfo->attterms_name)?$rowTermsInfo->attterms_name:''; ?>" type="text"></div>   
					...
					<div>
					<div class="input text required"><input name="attterms_slug"  placeholder="Enter Slug" class="form-control" id="tag_slug" value="<?php echo  isset($rowTermsInfo->attterms_slug)?$rowTermsInfo->attterms_slug:''; ?>" type="text"></div>   
						...
						<table class="table table-striped">
										...
										{ ?>	
											...
											<td style="text-align:center">
												...
												<td><?php echo $rowTagListInfo->attterms_name; ?></td>
...
{ ?>
																<li><a href="<?php echo $this->Url->build('/admin/attribute/configure/'.$rowTagInfo->att_id.'/'.$rowTagListInfo->attterms_id); ?>" style="padding:3px 15px">Edit</a></li>
																	<?php } ?>
																<?php if($rowSelectPermission['pd_delete']==1)
{ ?>
																<li><a href="<?php echo $this->Url->build('/admin/attribute/deleteterms/'.$rowTagInfo->att_id.'/'.$rowTagListInfo->attterms_id); ?>" style="padding:3px 15px">Delete</a></li>
																	<?php } ?>
